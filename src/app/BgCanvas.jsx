        ...
        function drawGrid() {
            ...
            for (let x = 0; x <= canvas.width; x += gridSpacingX) {
                ...
                for (let y = 0; y <= canvas.height; y += 3) {
                    ...
                    const perspectiveWarp = Math.pow(distanceFromCenter, 2) * nx * warpStrengthX * warpScale;
            ...
            for (let y = 0; y <= canvas.height; y += gridSpacingY) {
                ...
                for (let x = 0; x <= canvas.width; x += 3) {
                    ...
                    // Perspective effect
                    const perspectiveWarp = Math.pow(distanceFromCenter, 2) * ny * warpStrengthY * warpScale;

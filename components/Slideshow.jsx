...
const Slideshow = () => {
	...
	const images = [
		...
		{
			name: "Java Script",
			url: "/tech_icons/JS.png",
			height: 100,
			width: 100,
		},
		{
			name: "jQuery",
			url: "/tech_icons/jquery.png",
			height: 100,
			width: 100,
		},
		...
		{
			name: "Mongo DB",
			url: "/tech_icons/mongodb.png",
			height: 100,
			width: 300,
		},
		{
			name: "Markdown",
			url: "/tech_icons/markdown.png",
			height: 90,
			width: 120,
		},
		{
			name: "Raspberry Pi",
			url: "/tech_icons/rbpi.png",
			height: 100,
			width: 80,
		},
		...
		{
			name: "Docker",
			url: "/tech_icons/docker.png",
			height: 100,
			width: 120,
		},
		{
			name: "Arduino",
			url: "/tech_icons/arduino.png",
			height: 90,
			width: 120,
		},
	];
